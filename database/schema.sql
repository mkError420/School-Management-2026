...
-- --------------------------------------------------------
-- Table 1: `tenants` (Multitenancy Support)
-- --------------------------------------------------------
CREATE TABLE `tenants` (
  `id` BIGINT UNSIGNED AUTO_INCREMENT PRIMARY KEY,
  `tenant_code` VARCHAR(50) NOT NULL UNIQUE,
  `school_name_en` VARCHAR(200) NOT NULL,
  `school_name_bn` VARCHAR(200) NOT NULL,
...
INSERT INTO `tenants` (`id`, `tenant_code`, `school_name_en`, `school_name_bn`, `domain`, `subdomain`, `address`, `upazila`, `district`, `phone`, `email`, `status`, `subscription_plan`, `max_students`, `max_teachers`) VALUES
(1, 'TNT-SONAR-001', 'SonarPathshala High School', 'সোনারপাঠশালা উচ্চ বিদ্যালয়', 'maneschool.site.je', 'sonarpathshala', 'Dhanmondi, Dhaka', 'Dhanmondi', 'Dhaka', '+8801711000001', 'admin@maneschool.site.je', 'active', 'premium', 2000, 100);
...
INSERT INTO `users` (`id`, `uuid`, `tenant_id`, `role_id`, `username`, `email`, `phone`, `password_hash`, `full_name_en`, `full_name_bn`) VALUES
(1, 'u-superadmin-001', NULL, 1, 'superadmin', 'admin@maneschool.site.je', '+8801711000001', '$2y$12$K8y5E1U9Z3x8F7Q8J4gUu.VlU.gHq9nKq1XQG2aT4YpXG6k.M7i', 'Md. Zahirul Islam', 'মো. জহিরুল ইসলাম'),
(2, 'u-headmaster-002', 1, 2, 'principal_anwar', 'principal@maneschool.site.je', '+8801711002233', '$2y$12$K8y5E1U9Z3x8F7Q8J4gUu.VlU.gHq9nKq1XQG2aT4YpXG6k.M7i', 'Prof. Md. Anwar Hossain', 'অধ্যাপক মোঃ আনোয়ার হোসেন'),
(3, 'u-teacher-003', 1, 3, 'tariqul_math', 'tariqul.math@maneschool.site.je', '+8801715443322', '$2y$12$K8y5E1U9Z3x8F7Q8J4gUu.VlU.gHq9nKq1XQG2aT4YpXG6k.M7i', 'Md. Tariqul Islam', 'মোঃ তারিকুল ইসলাম'),
(4, 'u-staff-004', 1, 4, 'accounts.hasan', 'accounts@maneschool.site.je', '+8801713000004', '$2y$12$K8y5E1U9Z3x8F7Q8J4gUu.VlU.gHq9nKq1XQG2aT4YpXG6k.M7i', 'Kamrul Hasan', 'কামরুল হাসান');
...
-- --------------------------------------------------------
-- Table 6: `student_extracurriculars`
-- --------------------------------------------------------
...
-- --------------------------------------------------------
-- Table 7: `student_medical_histories`
-- --------------------------------------------------------
...
-- --------------------------------------------------------
-- Table 8: `student_emergency_contacts`
-- --------------------------------------------------------
